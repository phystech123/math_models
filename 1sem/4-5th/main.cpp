...
//         double k1_x = h*V[i-1];
//         double k1_v = h*(-pow(W, 2)*X[i-1]);

//         double k2_x = h*(V[i-1] + k1_v/2.);
//         double k2_v = h*(-pow(W, 2)*(X[i-1] + k1_x/2.));

//         double k3_x = h*(V[i-1] + k2_v/2.);
//         double k3_v = h*(-pow(W, 2)*(X[i-1] + k2_x/2.));

//         double k4_x = h*(V[i-1] + k3_v);
//         double k4_v = h*(-pow(W, 2)*(X[i-1] + k3_x));

//         X[i] = X[i-1] + (1/6.)*(k1_x + 2*(k2_x+k3_x) + k4_x);
//         V[i] = V[i-1] + (1/6.)*(k1_v + 2*(k1_v+k3_v) + k4_v);
//     }
// }
